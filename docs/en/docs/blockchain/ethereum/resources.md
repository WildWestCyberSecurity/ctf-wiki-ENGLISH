...
## Books
- "Erta Technical Details and Practice" -- Highly recommended by Ethereum founder and Chief Scientist Vitalik Buterin
- To be supplemented

## papers
- Smart Contracts [https://github.com/hzysvilla/Academic_Smart_Contract_Papers](https://github.com/hzysvilla/Academic_Smart_Contract_Papers)
- Blockchain (including Smart Contracts) [https://github.com/jianyu-niu/blockchain_conference_paper](https://github.com/jianyu-niu/blockchain_conference_paper)
- To be supplemented

## Security Tools

> Ported from [https://consensys.github.io/smart-contract-best-practices/security_tools/](https://consensys.github.io/smart-contract-best-practices/security_tools/)
